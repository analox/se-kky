...
public class Problem {
	...
	public Problem(Element elem) {
		...
		else if (name.compareTo("SchwefelNoise") == 0)
			problemID = FitnessFunction.F_SchwefelNoise;
		else if (name.compareTo("Step") == 0)
			problemID = FitnessFunction.F_Step;
		else if (name.compareTo("Bump") == 0)
			problemID = FitnessFunction.F_Bump;
		else problemID = -1;
	}
