...
import mytest.evaluation.real.OSS2Params;
...
public class EARun extends EARunTemplate{
	...
	public static void main(String[] args) {
		...
		ConfigContainer profile = new ConfigContainer("maconf.xml");
//		ConfigContainer profile = new ConfigContainer(args[0]);
		...
		chromDim = new int[1]; chromDim[0] = nDim;
...
//		FitnessFunction evalFunc = 
//			getFitnessFunc(profile.problem.problemID, profile.method.chromosomeDim, true);
		if (f != null)
		{
			/*
