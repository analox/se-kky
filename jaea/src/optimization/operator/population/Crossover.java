...
//    private boolean binaryCoded = GAProfile.binaryCoded;
    ...
    public Vector<Individual> doProcess(Vector<Individual> indivs)
    {
    	...
    	int repPoolSize = indivs.size();
    	int iCnt, iIndex;
        int indexParent1 = -1, indexParent2 = -1;
        Individual indiv1, indiv2;

        /* Mating process */
        int [][] mateIndexes = null;
        mateIndexes = selectTwoParents(poolSize);
        ...
        do
        {
            indexParent1 = mateIndexes[iIndex][0]%repPoolSize;
            indexParent2 = mateIndexes[iIndex][1]%repPoolSize;
            iIndex++;
